...
| AUTO-003 | 原样初始化模板 | 对原始模板和生成的未修改 PRD 运行普通 lint | 0 错误、0 待填写预警；编辑后缺项恢复提示，开发门禁仍阻断 |
...
| AUTO-039 | 中文文末状态表 | 将旧英文字段改为文末中文表 | Development Ready 门禁读取状态；G1 改为 FAIL 时仍阻断 |
| AUTO-040 | 中文状态触发专家团 | 文末风险等级设为 L2 且缺专家团记录 | 包级校验报 `missing_expert_panel` |
